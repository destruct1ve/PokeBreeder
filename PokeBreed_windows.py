...
def pokecreate():
	...
	while createloop>0:
		...
		print("\n\n \033[94m Command ('help' for a list of commands): \033[00m")
		comm = input(" ")
		...
		try:
			if comm.lower() == 'help':
				...
				while sloop>0:
					clearscreen()
					print("\n\033[92mPlease type a save name for your save file, and then hit Enter (or 'exit' to go back): \033[00m")
					filename = input(" ")
					filename = filename+".breed"
